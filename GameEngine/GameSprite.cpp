...
GameSprite :: GameSprite( SpriteBatchName::Name _spriteBatchName, SpriteName::Name _spriteName, ImageName::Name imageName, Rect destRect)
{
	this->setName( 0 );
	this->spriteBatchName = _spriteBatchName;
	...
	SBNode *batch = SpriteBatchManager::Find(_spriteBatchName);
	assert( batch != 0 );
